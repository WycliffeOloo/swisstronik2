...
async function main() {
    const replace_contractAddress = "0xE532C1BB33Ec2796e6C7d0c0A8A482f6C50006A7";
    const [signer] = await hre.ethers.getSigners();
    const replace_contractFactory = await hre.ethers.getContractFactory("OSIEPNA");
    const contract = replace_contractFactory.attach(replace_contractAddress);
  
    const replace_functionName = "mint";
    const replace_functionArgs = ["0x573E07B6F63eEAb2087399c34764D3Bb26EdB8f4","100000000000000000000"]; // 100 tokens with 18 decimal places
